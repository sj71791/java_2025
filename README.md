...
#### 2025-06-27
1. figma 뷰 작업
2. 리뷰 테이블 설계 수정하였다 (날씨 api를 리뷰 작성 시점에만 호출해 상태만 저장하고, 리뷰타입 테이블 추가함) 
3. 엔티티 작업
---
...
#### 2025-04-23
1. 포트폴리오 팀작업 (드디어 member, review, book 조립  리뷰 list 와 리뷰 detail 페이지에 조립)
...
#### 2025-04-14
1. 포트폴리오 팀작업 (ERD, 깃허브에서 프로젝트 내려받고 branch 만들기)
---
