...
<%
	//jsp022_logout.jsp
	//1. session 초기화코드
	//2. login.jsp 페이지로 넘기기 (10초뒤에-안내)
	session.invalidate();

	// >>>> 경로바로 넘기기
	//ver-1	 out.println("<script>alert('로그아웃합니다.'); location.href='jsp022_login.jsp';</script>");
	//ver-2		
	...
	// >>>> sendRedirect (request, response유지 안됨.)/dispatcher 차이점 ???
