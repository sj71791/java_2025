...
class Cat extends Animal{
	@Override void eat() { System.out.println(super.name+"고양이는 냠냠");  }

	@Override void sleep() { System.out.println(super.name+"고양이는 코");  }
...
public class Abstract001 {
	public static void main(String[] args) {
		...
		// Animal ani = new Animal();  new 메모리빌리고, 객체생성 / Animal() 초기화/ {} 구현부없음
		Animal ani=null;
